...
{
    /// <inheritdoc />
    public partial class AddImportAirRequests : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ImportAirRequests",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportAirRequests", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ImportAirRequestDimensions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ImportAirRequestId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportAirRequestDimensions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImportAirRequestDimensions_ImportAirRequests_ImportAirReque~",
                        column: x => x.ImportAirRequestId,
                        principalTable: "ImportAirRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ImportAirRequestDimensions_ImportAirRequestId",
                table: "ImportAirRequestDimensions",
                column: "ImportAirRequestId");
        }

...
public record CreateCarrierDto
{
    ...
    public IReadOnlyList<CreateCarrierContactPersonDto> ContactPersons { get; init; } = [];
    public IReadOnlyList<CreateCarrierBankAccountDto> BankAccounts { get; init; } = [];
    public IReadOnlyList<Guid> ManagerIds { get; init; } = [];
}

public record CreateCarrierContactPersonDto
{
...
public record CreateCarrierBankAccountDto
{

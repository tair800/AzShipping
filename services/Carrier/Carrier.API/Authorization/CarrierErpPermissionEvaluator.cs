...
internal static class CarrierErpPermissionEvaluator
{
    ...
    public static Task ApplyAsync(AuthorizationFilterContext context, IReadOnlyList<string> anyOf)
    {
        ...
        context.Result = new JsonResult(
            new { error = "erp_permission_forbidden", message = "Insufficient Carriers module permissions for this action." },
            JsonErr)
        {

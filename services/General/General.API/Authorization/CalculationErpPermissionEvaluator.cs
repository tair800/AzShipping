...
internal static class CalculationErpPermissionEvaluator
{
    ...
    public static Task ApplyAsync(AuthorizationFilterContext context, IReadOnlyList<string> anyOf)
    {
        ...
        context.Result = new JsonResult(
            new { error = "erp_permission_forbidden", message = "Insufficient Calculation module permissions for this action." },
            JsonErr)
        {

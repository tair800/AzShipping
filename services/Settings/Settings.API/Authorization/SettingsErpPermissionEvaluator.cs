...
internal static class SettingsErpPermissionEvaluator
{
    ...
    public static Task ApplyAsync(AuthorizationFilterContext context, IReadOnlyList<string> anyOf)
    {
        ...
        context.Result = new JsonResult(
            new { error = "erp_permission_forbidden", message = "Insufficient Settings module permissions for this action." },
            JsonErr)
        {

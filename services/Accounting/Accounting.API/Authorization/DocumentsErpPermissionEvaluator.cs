...
internal static class DocumentsErpPermissionEvaluator
{
    ...
    public static Task ApplyAsync(AuthorizationFilterContext context, IReadOnlyList<string> anyOf)
    {
        ...
        context.Result = new JsonResult(
            new { error = "erp_permission_forbidden", message = "Insufficient Documents module permissions for this action." },
            JsonErr)
        {
